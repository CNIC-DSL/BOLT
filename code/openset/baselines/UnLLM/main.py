...
def main(model_args, data_args, training_args):
    ...
    if data_args.known_labels_file and os.path.exists(data_args.known_labels_file):
        data_args.num_labels = len(pd.read_csv(data_args.known_labels_file, header=None))
    else:
