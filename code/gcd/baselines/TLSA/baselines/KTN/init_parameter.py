...
def init_model():
    ...
    # Model saving and output parameters
    ...
    # Method name parameter (for saving results)
    parser.add_argument("--method", default='KTN', type=str,
