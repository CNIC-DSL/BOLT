...
def init_model():
    ...
    parser.add_argument("--api_key", type=str, default='',
                        help="The key for Openai API. If empty, read from env LLM_API_KEY or OPENAI_API_KEY.")

    parser.add_argument("--api_base", type=str, default='',
                        help="LLM API base URL (OpenAI-compatible). If empty, read from env LLM_BASE_URL.")

    parser.add_argument("--llm_model_name", type=str, default='',
                        help="LLM model name. If empty, read from env LLM_MODEL.")
    ...
    parser.add_argument("--bert_model", default="./pretrained_models/bert-base-uncased", type=str,
                        help="The path or name for the pre-trained bert model. If empty, auto-select based on dataset.")

    parser.add_argument("--tokenizer", default="./pretrained_models/bert-base-uncased", type=str,
                        help="The path or name for the tokenizer. If empty, use bert_model path.")
