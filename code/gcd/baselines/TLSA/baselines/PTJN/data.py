...
class Data:
    def __init__(self, args):
        self.args = args
        set_seed(args.seed)
        MAX_SEQ_LEN = {'clinc':30, 'stackoverflow':45, 'banking':55,'mcid': 65, 'ecdt': 65,'hwu': 20, 'thucnews': 256}
        TRAIN_EPOCH = {'clinc':60, 'stackoverflow':40, 'banking':50,'mcid': 65, 'ecdt': 65,'hwu': 65, 'thucnews': 45}
        LAMBDA_T = {'clinc': 0.7, 'stackoverflow': 0.1, 'banking': 0.3, 'mcid': 0.5, 'ecdt': 0.4, 'hwu': 0.6, 'thucnews': 0.5}
        LAMBDA_V = {'clinc': 0.51, 'stackoverflow': 0.50, 'banking': 0.51, 'mcid': 0.50, 'ecdt': 0.50, 'hwu': 0.51, 'thucnews': 0.50}
