...
def init_model():
    ...
    parser.add_argument("--lambda_t", default=0.1, type=float, help="The ratio of labeled samples in the training set.")

    parser.add_argument("--lambda_v", default=0.51, type=float, help="The ratio of labeled samples in the training set.")
