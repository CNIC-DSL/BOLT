...
class PretrainModelManager:
    ...
    def train(self):
        ...
        pbar = tqdm(range(int(self.args.num_pretrain_epochs)), desc="Pretraining Epochs")
        ...
        for epoch in pbar:
            ...
            pbar.set_postfix({
                ...
                'best_score': f'{self.best_eval_score:.2f}'
            })
            ...
            if eval_score > self.best_eval_score:
                ...
                if wait >= self.args.wait_patient:
                    pbar.set_description(f"Pretraining Epochs (Early Stop at {epoch+1})")
                    break
