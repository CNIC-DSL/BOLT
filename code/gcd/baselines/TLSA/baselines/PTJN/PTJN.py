...
class ModelManager:
    ...
    def train(self, args, data):
        ...
        pbar = tqdm(range(1, int(args.num_train_epochs) + 1), desc="Training Epochs")
        ...
        for epoch in pbar:
            ...
            pbar.set_postfix({
                'loss': f'{avg_loss:.4f}',
                'lambda_t': f'{args.lambda_t:.2f}',
                'lambda_v': f'{args.lambda_v:.2f}'
            })
    ...
    def save_results(self, args, test_results):
        ...
        var = [args.dataset, 'PTJN', args.known_cls_ratio,
...
if __name__ == '__main__':
    ...
    final_results = manager.evaluation(args, data)
