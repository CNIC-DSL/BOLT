...
class Data:
    ...
    def __init__(self, args):
        set_seed(args.seed)
        max_seq_lengths = {'hwu': 20, 'clinc': 30, 'banking': 65, 'stackoverflow': 65, 'mcid': 65, 'ecdt': 65, 'thucnews': 512}
        beta_list = {'hwu': 0.05, 'clinc': 0.42, 'banking': 0.03, 'stackoverflow': 0.05, 'mcid': 0.05, 'ecdt': 0.05, 'thucnews': 0.05}
