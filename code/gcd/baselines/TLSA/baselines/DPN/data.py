...
class Data:
    ...
    def __init__(self, args):
        ...
        max_seq_lengths = {'clinc':30, 'stackoverflow':45, 'banking':55,'mcid': 65, 'ecdt': 65,'hwu': 20, 'thucnews': 256}
        train_epochs = {'clinc':80, 'stackoverflow':10, 'banking':60, 'mcid': 80, 'ecdt': 80, 'hwu': 80, 'thucnews': 60}
        gamma_list = {'clinc':10, 'stackoverflow':90, 'banking':10, 'mcid': 30, 'ecdt': 30, 'hwu': 30, 'thucnews': 30}
