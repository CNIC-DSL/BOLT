class Param():
    ...
    def get_hyper_parameters(self, args):
        ...
        if args.dataset == 'banking':
            ...
            hyper_parameters = {
                'pretrained_bert_model': './pretrained_models/bert-base-uncased',
                'max_seq_length': None,
            ...
            print("==============ecdt config")
            hyper_parameters = {
                'pretrained_bert_model': './pretrained_models/bert-base-chinese',
                'max_seq_length': None,
                'num_pretrain_epochs': 100,
                'num_train_epochs': 100,
                'num_labels': None,
