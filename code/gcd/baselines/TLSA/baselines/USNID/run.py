...
def parse_arguments():
    ...
    parser.add_argument("--output_dir", default= 'model_outputs', type=str,
                        help="The output directory where the model predictions and checkpoints will be written (only saved when --save_model is set).")
