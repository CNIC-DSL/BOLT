...
max_seq_lengths = {'mcid':21, 'clinc':30, 'stackoverflow':45, 'banking':55, 'ecdt':55, 'hwu':55, 'thucnews':256}
...
class NIDData:
    ...
    def process_data(self, examples, label_map, mask_label=False, append_label=False):
        ...
        for idx, example in enumerate(examples):
            ...
            # Decode to get truncated text (consistent with BERT input for fair comparison)
...
class MemoryBank(object):
    ...
    def mine_nearest_neighbors(self, topk, calculate_accuracy=True, gpu_id=0):
        ...
        if hasattr(faiss, 'StandardGpuResources'):
            ...
            print("Using CPU resources (faiss-gpu not found or incompatible)...")
