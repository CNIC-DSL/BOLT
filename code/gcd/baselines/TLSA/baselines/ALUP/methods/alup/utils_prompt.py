PROMPT_GCD = \
"""Your role is to identify the **category** of a given **query sample** by comparing it with a provided **reference sample set**.

- Category: The underlying class or type of the sample.
- Known Categories: Categories that are already represented in the reference set.
- Novel Categories: Categories that are new and not represented in the reference set.

Your Task:
Given a **query sample**, identify the sample from the **reference sample set** that belongs to the **same category**. Each sample in the set represents a distinct category.

Important Rules:
1. **Do not guess.** If you are not absolutely certain that a sample shares the same category as the query sample, **you must return "Cluster_id: -1."**
2. **A match requires full alignment of category.** Partial overlaps (e.g., similar keywords but different underlying semantics) do not count as a match.
...
Cluster_id: 37. Sample: how about disposable virtual cards?
Cluster_id: 39. Sample: is there a charge for getting more cards?
Cluster_id: 29. Sample: What is the limit to disposable cards you can have?
Cluster_id: 60. Sample: can you tell me the limit for top ups?
Cluster_id: 10. Sample: can cards be delivered? where?
Cluster_id: 3. Sample: what atms can i use my card?
Cluster_id: 14. Sample: my card won't work right now.
Cluster_id: 36. Sample: i need to know which flat currencies are supported by you.
Cluster_id: 43. Sample: can i order a second card?
Cluster_id: 63. Sample: why have i been charged more than once for the same transaction?
Cluster_id: 22. Sample: i think someone is using my card without my permission!
Cluster_id: 4. Sample: i need help finding the auto top up option.
Cluster_id: 23. Sample: good day, in reviewing my credit card activity over the last several days, i see a repeated charge for a restaurant that i went to. the charge was put through twice, so i would like one of the charges corrected and the amount that was withdrawn to be reinstated
Cluster_id: 40. Sample: what is the virtual card and how can i get one?
Cluster_id: 54. Sample: what currencies do you accept to add money?
Cluster_id: 11. Sample: i'm still waiting on my new card to be delivered!
Cluster_id: 73. Sample: can i get a visa or mastercard?
Cluster_id: 15. Sample: how come i was charged an extra fee when paying with the card?
Cluster_id: 12. Sample: can i change my pin at any atm?
Cluster_id: 31. Sample: what is the charge for exchanging currency?
Cluster_id: 13. Sample: my phone got stolen, how can i use the app?
Cluster_id: 68. Sample: why do i have a charge for an atm withdrawal? i thought these were free?
Cluster_id: 16. Sample: i don't think i made this payment that is showing up
Cluster_id: 49. Sample: my pin seems to be blocked, help me access it?
Cluster_id: 0. Sample: i need more assistance with how to activate my card.
Cluster_id: 41. Sample: i've lost my card. what can i do about that?
Cluster_id: 26. Sample: is there something wrong with the atm? it would not let me pull cash out of my account.
Cluster_id: 9. Sample: if my card expires next month, will i need to order a new one?
Cluster_id: 57. Sample: are there fees for using an international card to top up?
Cluster_id: 45. Sample: i made a payment but it's still pending
Cluster_id: 2. Sample: how can i get my google pay top up to work?
Cluster_id: 1. Sample: what is the appropriate age for my child to be able to open an account?
Cluster_id: 25. Sample: the card payment is declined. please inform me why.
Cluster_id: 13. Sample: i've obtained the card, how do i enable it on the app?
Cluster_id: 38. Sample: where can i find my pin? i haven't gotten it yet.
Cluster_id: 18. Sample: i contacted a seller about a refund last week but he still hasn't returned my money. i am frustrated and need these funds. please help me get my money back.
Cluster_id: 52. Sample: how do i receive a refund for my item?
Cluster_id: 53. Sample: why would my card payment be reverted?

Query Sample:
How many transactions can I do with one disposable card?

Identified Sample:
Cluster_id: 29. Sample: what is limit of disposable cards i can make per day?

## Example 2:
Reference Sample Set:

Cluster_id: 47. Sample: how long will it take for my top up to work? it's still pending
Cluster_id: 25. Sample: please help me in this, as i was unable to make any payment by my new card,  it was getting declined repeatedly. i am not very happy with this incident.
Cluster_id: 61. Sample: my top-up was reverted by the app.
Cluster_id: 57. Sample: i need to know what charges i will incur for using a european card for top up.
Cluster_id: 18. Sample: my card payment didn't work
Cluster_id: 65. Sample: how can i transfer money using my credit card?
Cluster_id: 26. Sample: this is the first time i've tried to get my money out of an atm and it didn't work. please give me my money
Cluster_id: 60. Sample: is there a limit to how much i can top-up?
Cluster_id: 71. Sample: why do i have to verify my top-up card?
Cluster_id: 14. Sample: my card don't work.
Cluster_id: 15. Sample: i noticed an extra fee when i paid with my card.
Cluster_id: 27. Sample: my transfer was declined. why did this happen?
Cluster_id: 3. Sample: what currencies do you accept for adding money?
Cluster_id: 35. Sample: i tried and tried, but i could not complete my transfer. tell me what is wrong.
Cluster_id: 19. Sample: i was told that withdrawing cash from the atm is free, but i'm charged a fee. why is this?
Cluster_id: 75. Sample: i asked for a certain amount of money from the atm, but it gave me a different amount. less than what i asked for.
Cluster_id: 76. Sample: i believe i got a wrong exchange rate when i got cash.
Cluster_id: 2. Sample: how can i top up with apple pay?
Cluster_id: 21. Sample: my card payment reverted back, i think.
Cluster_id: 22. Sample: can you check about unauthorized use of my card, i think someone is using mine without my knowledge?
Cluster_id: 17. Sample: i bought something while traveling, and the exchange rate was wrong.
Cluster_id: 46. Sample: why would a cash withdrawal still be pending?
Cluster_id: 23. Sample: yesterday, i made an incorrect payment to the wrong account for my rent payment. i need this addressed as soon as possible and the funds transferred to the correct account by no later than tomorrow.
Cluster_id: 12. Sample: what atms accept my card?
Cluster_id: 4. Sample: how do i access the auto top-up option?
Cluster_id: 45. Sample: why is my card payment still pending? it should have gone through already.
Cluster_id: 67. Sample: i need to transfer funds from china and quick expedition is crucial. approximately how long does it take for a transfer from china to go through?
Cluster_id: 58. Sample: i had a cheque deposited, but i don't see my money yet?
Cluster_id: 36. Sample: what currencies are supported?
Cluster_id: 56. Sample: will i be charged for adding money by transfer?
Cluster_id: 24. Sample: can i get a card in the eu?
Cluster_id: 41. Sample: i've lost my card. what can i do about that?
Cluster_id: 20. Sample: the app says i made a cash withdrawal that i didn't make
Cluster_id: 6. Sample: i made a check deposit but the cash hasn't arrived in my account yet.
Cluster_id: 40. Sample: i want to get my hands on one of those virtual cards!
Cluster_id: 39. Sample: where do i order additional cards?
Cluster_id: 62. Sample: i deposited money but my balance hasn't been updated yet.
...
Identified Sample:
Cluster_id: -1. (No sample in the set matches the query category.)
...
Cluster_id: 24. Sample: can i get a card in the eu?
Cluster_id: 39. Sample: where do i order additional cards?
Cluster_id: 12. Sample: when will my card be delivered?
Cluster_id: 12. Sample: what atms accept my card?
Cluster_id: 57. Sample: i need to know what charges i will incur for using a european card for top up.
Cluster_id: 11. Sample: my card hasn't arrived yet. what do i do?
Cluster_id: 32. Sample: i need to know what your exchange rates are.
Cluster_id: 65. Sample: how can i transfer money using my credit card?
Cluster_id: 13. Sample: how do i link a new card in the app?
Cluster_id: 56. Sample: will i be charged for adding money by transfer?
Cluster_id: 69. Sample: what are the steps to verify identity?
Cluster_id: 27. Sample: are there steps to see where my funds come from?
Cluster_id: 29. Sample: how many uses are the disposable cards good for?
Cluster_id: 60. Sample: is there a limit to how much i can top-up?
Cluster_id: 67. Sample: i need to transfer funds from china and quick expedition is crucial. approximately how long does it take for a transfer from china to go through?
Cluster_id: 1. Sample: how old do you need to be to open an account?
Cluster_id: 43. Sample: i would like to get an account for my child.
Cluster_id: 0. Sample: i need more assistance with how to activate my card.
Cluster_id: 9. Sample: my card will expire next month, will i need to order a new one?
Cluster_id: 5. Sample: how long should i have to wait before i see the transfer in my account?
Cluster_id: 25. Sample: please help me in this, as i was unable to make any payment by my new card,  it was getting declined repeatedly. i am not very happy with this incident.
Cluster_id: 18. Sample: how can my friend send money to me?
Cluster_id: 41. Sample: i've lost my card. what can i do about that?
Cluster_id: 15. Sample: i noticed an extra fee when i paid with my card.
Cluster_id: 75. Sample: i asked for a certain amount of money from the atm, but it gave me a different amount. less than what i asked for.
Cluster_id: 38. Sample: where is my pin?
Cluster_id: 52. Sample: is it possible to get a refund for the item?
Cluster_id: 33. Sample: how can i exchange currencies
Cluster_id: 37. Sample: i made a purchase recently but i have decided that i'm not buying it and i need to receive my money back. can you please give me a refund asap. it's extremely urgent.
Cluster_id: 6. Sample: i made a check deposit but the cash hasn't arrived in my account yet.
Cluster_id: 66. Sample: why hasn't the transaction i did to my friend arrived yet?
Cluster_id: 40. Sample: i want to get my hands on one of those virtual cards!
Cluster_id: 22. Sample: can you check about unauthorized use of my card, i think someone is using mine without my knowledge?
Cluster_id: 27. Sample: my transfer was declined. why did this happen?
Cluster_id: 14. Sample: my card don't work.
...
Instructions:
1. **Compare the query sample with each sample in the reference set** by analyzing their semantic meaning. Focus on the **underlying category** of each sample.
2. **Prioritize the order of the reference set.** Compare samples from top to bottom, as samples earlier in the set are more likely to be matches.
3. Identify a matching sample only if the category is **exactly the same as the query sample**. If there is any uncertainty or if the categories are not clearly aligned, do not make a match.
4. If a match is found, write the **Cluster_id** and **Sample** of the identified match.
...
Identified Sample:
[Provide the final output here (**Cluster_id** and **Sample** or Cluster_id: -1.) .]
"""
