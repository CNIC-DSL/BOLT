...
def init_model():
    ...
    parser.add_argument(
        "--method", type=str, default="DeepAligned", help="Which method to use."
    )
    ...
    parser.add_argument(
        "--num_train_epochs", default=100, type=float, help="The training epochs."
    )
    ...
    parser.add_argument(
        "--lr", default=5e-5, type=float, help="The learning rate for training."
    )
