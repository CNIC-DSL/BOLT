...
def init_model():
    ...
    parser.add_argument(
        ...
        default=0.9,
        type=float,
        help="The weighting factor of the EMA updating for labeled prototypes.",
    )
    ...
    parser.add_argument(
        "--method", default="DPN", type=str, help="The name of the method."
    )
